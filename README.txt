...
raw = load '/app-logs/rajesh/logs/application_1411511669099_0591/*' using org.pig.storage.TFileStorage() AS (machine:chararray, key:chararray, line:chararray);
filterByLine = FILTER raw BY (key MATCHES '.*container_1411511669099_0591_01_000001.*') AND (line MATCHES '.*Shuffle.*');
dump filterByLine;
